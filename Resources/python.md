...
Here are NumPy documentation websites that demonstrate how to create `numpy`
arrays in code and from input files:
...
* [Matplotlib Lecture](https://lectures.scientific-python.org/intro/matplotlib/index.html)
